...
export interface IWindowSettings {
	...
	readonly enableExperimentalProxyLoginDialog: boolean;
	readonly transparent: boolean;
	readonly compositionAttribute: 'none' | 'transparent' | 'blur' | 'acrylic';
	readonly vibrancy: 'none' | 'appearance-based' | 'light' | 'dark' | 'titlebar' | 'medium-light' | 'ultra-dark';
}
